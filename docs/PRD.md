...
| # | 섹션 | 목적 | MoSCoW |
|---|---|---|---|
| 1 | **로고 히어로** — 브랜드 로고 대형 + "서울이모삼촌" 워드마크 + 태그라인 + 신뢰 배지(50플러스재단·유급) + 이중 CTA | 진입 즉시 로고·정체성·공신력 | Must |
...
**기능**
- 히어로: 브랜드 로고 이미지(대형) + "서울이모삼촌" + 태그라인 + 신뢰 배지 + CTA 2개(**[시니어 호스트 신청하기]** 라임그린 채움·어두운 글자 · [모집 공고 보기] 보조 아웃라인).
...
**수용기준 (AC)**
- Given 카톡 인앱 브라우저 진입, When 첫 화면 렌더, Then **로고·브랜드명·[신청하기]·신뢰배지**가 스크롤 없이 보인다.
...
- **컬러**: 흰색 배경(#FFFFFF) 메인 + 옅은 라임 보조면(#F4F7EA, 교차 섹션) + **대표 라임그린 #D3E298**(버튼·배지·태그·강조 **배경**, 반드시 **어두운 글자** 동반) + **진한 라임 #4E6A18**(링크·작은 라벨·흰글자 바 등 밝은색이 물리적으로 불가한 곳) + 차콜 텍스트(#23201C). 골드(#C79438)는 보조 악센트(안내 태그). 순흑 지양.
...
- **타이포**: 본문·UI·헤딩은 **Pretendard(고딕)** 로 공신력·가독 확보. **로고 옆 브랜드명 "서울이모삼촌"만 Noto Sans KR 700**(2026-07-22 사용자 선택 = 폰트 A). 명조·대형 서사 헤드라인은 쓰지 않는다(AI스러운 인상 회피).
